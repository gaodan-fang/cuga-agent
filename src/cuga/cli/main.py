...
def start(
    service: str = typer.Argument(
        ...,
        help="Service to start: demo, demo_crm, demo_docs, demo_health, demo_knowledge, demo_supervisor, travel_agent, manager, registry, appworld, or memory",
    ),
...
def stop(
    service: str = typer.Argument(
        ...,
        help="Service to stop: demo, demo_crm, demo_docs, demo_health, demo_knowledge, demo_supervisor, travel_agent, registry, appworld, or memory",
    ),
):
    """
...
def status(
    service: str = typer.Argument(
        "all",
        help="Service to check status: demo, demo_crm, demo_docs, demo_health, demo_supervisor, travel_agent, registry, appworld, memory, or all",
    ),
):
    """
